...
npm test            # tsx test/run.ts — <!-- vital:testcount -->410 tests, real sockets, real sqlite<!-- /vital:testcount -->
...
Typecheck clean, suite <!-- vital:testcount -->410/410 green<!-- /vital:testcount -->.
Typecheck clean, suite <!-- vital:testcount -->410/410 green<!-- /vital:testcount -->.
