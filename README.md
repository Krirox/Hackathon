...
npm test            # tsx test/run.ts — <!-- vital:testcount -->355 tests, real sockets, real sqlite<!-- /vital:testcount -->
...
Typecheck clean, suite <!-- vital:testcount -->355/355 green<!-- /vital:testcount -->.
Typecheck clean, suite <!-- vital:testcount -->355/355 green<!-- /vital:testcount -->.
