...
npm test            # tsx test/run.ts — <!-- vital:testcount -->208 tests, real sockets, real sqlite<!-- /vital:testcount -->
```
...
Typecheck clean, suite <!-- vital:testcount -->208/208 green<!-- /vital:testcount -->.
