...
npm test            # tsx test/run.ts — <!-- vital:testcount -->346 tests, real sockets, real sqlite<!-- /vital:testcount -->
...
Typecheck clean, suite <!-- vital:testcount -->346/346 green<!-- /vital:testcount -->.
Typecheck clean, suite <!-- vital:testcount -->346/346 green<!-- /vital:testcount -->.
