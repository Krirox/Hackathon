...
npm test            # tsx test/run.ts — <!-- vital:testcount -->199 tests, real sockets, real sqlite<!-- /vital:testcount -->
```
...
Typecheck clean, suite <!-- vital:testcount -->199/199 green<!-- /vital:testcount -->.
