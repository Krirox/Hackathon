...
# Run the complete test suite (<!-- vital:testcount -->783/783 tests green<!-- /vital:testcount -->)
npm test
```
...
<!-- vital:testcount -->783/783 tests green<!-- /vital:testcount --> across the complete suite running against real SQLite databases and real socket connections.
