...
npm test            # tsx test/run.ts — <!-- vital:testcount -->359 tests, real sockets, real sqlite<!-- /vital:testcount -->
...
Typecheck clean, suite <!-- vital:testcount -->359/359 green<!-- /vital:testcount -->.
Typecheck clean, suite <!-- vital:testcount -->359/359 green<!-- /vital:testcount -->.
