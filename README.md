...
# Run the complete test suite (<!-- vital:testcount -->765/765 tests green<!-- /vital:testcount -->)
npm test
```
...
<!-- vital:testcount -->765/765 tests green<!-- /vital:testcount --> across the complete suite running against real SQLite databases and real socket connections.
