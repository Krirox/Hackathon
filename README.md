...
npm test            # tsx test/run.ts — <!-- vital:testcount -->416 tests, real sockets, real sqlite<!-- /vital:testcount -->
...
Typecheck clean, suite <!-- vital:testcount -->416/416 green<!-- /vital:testcount -->.
Typecheck clean, suite <!-- vital:testcount -->416/416 green<!-- /vital:testcount -->.
